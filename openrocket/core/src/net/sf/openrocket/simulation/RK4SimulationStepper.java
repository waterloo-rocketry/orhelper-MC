...
public class RK4SimulationStepper extends AbstractSimulationStepper {
	...
	private void storeData(RK4SimulationStatus status, DataStore store) {
        ...
        System.out.print(status.getSimulationTime());
        System.out.print(",");
                // Sims
        
        System.out.print(status.getRocketPosition().z);
        System.out.print(", ");
        ...
        System.out.print(store.linearAcceleration.length());
        System.out.print(", ");
        ...
        System.out.print(status.getRocketVelocity().length());
        System.out.print(", ");
		...
		if (status.isLaunchRodCleared()) {
			...
			if (store.forces != null && store.flightConditions != null && store.rocketMass != null) {
                ...
                System.out.print((store.forces.getCP().x - store.rocketMass.getCM().x) / store.flightConditions.getRefLength());
                System.out.print(", ");
		...
		if (store.flightConditions != null) {
            ...
            System.out.print(store.flightConditions.getAtmosphericConditions().getTemperature());
            System.out.print(", ");
        
            System.out.print(store.flightConditions.getAtmosphericConditions().getPressure());
            System.out.print(",");

            System.out.print(store.windSpeed);
            System.out.println();
